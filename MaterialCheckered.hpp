...
class MaterialCheckered : public Material
{
    ...
    MaterialCheckered(Color colorA = Color(1,1,1), Color colorB = Color(0,0,0), double ambient = 0.05, double diffuse = 1.0, double specular = 1.0, double reflection = 0.5, double transparency = 0.0, double ior = 1.0);
